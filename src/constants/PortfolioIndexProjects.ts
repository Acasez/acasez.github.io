export const mainProjects = [
  ...
  },
  {
    ...
    projectTags: ["TTRPG", "Solo", "Website", "Javascript", "Python", "SQLite"],
    name: "Kastorix (2023-)",
