...
"
      ...
      <PortfolioRowFrame reverse={false}>
        <PortfolioDoubleImageRow //Double Image
          imageLocationOne="images/Amsvartne/lightbehindwall.JPG"
          altTextOne="screenshot of the game, the player is walking through a door"
          imageLocationTwo="images/Amsvartne/shineBright.JPG"
      ...
      <PortfolioRowFrame reverse={false}>
        <PortfolioRow //Initial Idea
          name="Initial Idea"
          imageLocation="images/Amsvartne/FirstScreenshot.JPG"
...
"
      ...
      <PortfolioRowFrame reverse={true}>
        <PortfolioRow //Light as a Mechanic
          ...
          imageLocation="images/Amsvartne/TurnAroundWithLight.gif"
      ...
      <PortfolioRowFrame reverse={false}>
        <PortfolioDoubleImageRow //Double Image
          imageLocationOne="images/Amsvartne/CrystalLight.gif"
          ...
          imageLocationTwo="images/Amsvartne/MultipleBounces.gif"
      ...
      <PortfolioRowFrame reverse={false}>
        <PortfolioRow //Notes
          name="Notes"
          imageLocation="images/Amsvartne/ExplosivesNoteGif.gif"
...
"
      ...
      <PortfolioRowFrame reverse={true}>
        <PortfolioRow //Testing Toolkit
          ...
          imageLocation="images/Amsvartne/TestingToolkit.JPG"
