...
"
      ...
      <PortfolioRowFrame reverse={true}>
        <PortfolioRow //Design Process
          name="Design Process"
          imageLocation="src/Images/MariestadClimateGame/firstboard.png"
...
"
      ...
      <PortfolioRowFrame reverse={false}>
        <PortfolioRow //Card Evolution
          name="Card Evolution"
          imageLocation="src/Images/MariestadClimateGame/Kort evolution.jpg"
...
"
      ...
      <PortfolioRowFrame reverse={true}>
        <PortfolioRow //Inspiration and Research
          ...
          imageLocation="src/Images/MariestadClimateGame/info_Sheet-Backside.png"
      ...
      <PortfolioRowFrame reverse={false}>
        <PortfolioRow //Fall 2023 Playtesting
          ...
          imageLocation="src/Images/MariestadClimateGame/beforeButWithBonus.png"
      ...
      <PortfolioRowFrame reverse={true}>
        <PortfolioRow //Game Board Changes
          ...
          imageLocation="src/images/MariestadClimateGame/afterPlaytests.png"
...
"
      ...
      <PortfolioRowFrame reverse={false}>
        <PortfolioRow //Smaller Changes
          ...
          imageLocation="src/images/MariestadClimateGame/Lokala sponsorer.png"
...
"
      ...
      <PortfolioRowFrame reverse={true}>
        <PortfolioRow //Tested Ideas
          name="Tested Ideas"
          imageLocation="src/images/MariestadClimateGame/election.png"
...
"
      ...
      <PortfolioRowFrame reverse={false}>
        <PortfolioRow //The Search for a Card Making Tool
          ...
          imageLocation="src/images/MariestadClimateGame/BiologiskaStudier.png"
          altText="Example of the card Lokala Sponsorer"
